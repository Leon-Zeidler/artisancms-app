...
interface ProjectGalleryManagerProps { project: Project; user: User; }

export default function ProjectGalleryManager({ project, user }: ProjectGalleryManagerProps) {
  const supabase = useMemo(() => createSupabaseClient(), []);
  const [gallery, setGallery] = useState<GalleryImage[]>(project.gallery_images || []);
