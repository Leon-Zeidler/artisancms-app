...
export const INDUSTRY_TEMPLATES: Record<Industry, IndustryTemplate> = {
  maler: {
    ...
    heroImageUrl:
      "https://images.unsplash.com/photo-1613844044163-1ad2f2d0b152?q=80&w=1740&auto=format&fit=crop", // Painter
  },
  fliesenleger: {
    ...
    heroImageUrl:
      "https://images.unsplash.com/photo-1547414857-c9f61632b250?q=80&w=1740&auto=format&fit=crop", // Tiling
  },
  tischler: {
    ...
    heroImageUrl:
      "https://images.unsplash.com/photo-1619759247378-6a73e3ad45f1?q=80&w=1742&auto=format&fit=crop", // Carpenter
  },
  dachdecker: {
    ...
    heroImageUrl:
      "https://images.unsplash.com/photo-1643225523483-e2c434191bba?q=80&w=1740&auto=format&fit=crop", // Roofer
  },
  galabau: {
    ...
    heroImageUrl:
      "https://images.unsplash.com/photo-1734079692160-fcbe4be6ab96?q=80&w=1740&auto=format&fit=crop", // Landscaper
  },
  ...
  elektriker: {
    ...
    heroSubtitle:
      "Von Smart Home bis zur Wallbox – sicher, zuverlässig, innovativ.",
    ...
    heroImageUrl:
      "https://images.unsplash.com/photo-1646640381839-02748ae8ddf0?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Electrician
  ...
  sonstiges: {
    ...
    heroImageUrl:
      "https://plus.unsplash.com/premium_photo-1682370891536-ff08a5479f35?q=80&w=1740&auto=format&fit=crop", // Generic Workshop
  },
};

// --- Der Rest der Datei bleibt unverändert ---

export const INDUSTRY_OPTIONS = Object.entries(INDUSTRY_TEMPLATES).map(
  ([value, template]) => ({
...
export const resolveIndustry = (value: string | null | undefined): Industry => {
  ...
  return (Object.keys(INDUSTRY_TEMPLATES) as Industry[]).includes(
