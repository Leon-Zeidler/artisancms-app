...
const industryDescriptionPrompts: Partial<Record<Industry, string>> = {
  elektriker: "Fokus auf Sicherheit (VDE), moderne Technik (Smart Home, PV, Wallbox) und Zuverlässigkeit. Verwende Fachbegriffe korrekt.",
  maler: "Fokus auf Atmosphäre, saubere Ausführung, hochwertige Farben und die optische Verwandlung.",
  fliesenleger: "Fokus auf präzise Verlegung, moderne Materialien (Großformat, Mosaik) und die Gestaltung von Bädern/Wohnräumen.",
  tischler: "Fokus auf Maßarbeit, edle Hölzer, handwerkliche Qualität und clevere Detaillösungen.",
  //...
};
