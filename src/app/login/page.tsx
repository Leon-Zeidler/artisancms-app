      ...
      <div className="w-full max-w-lg space-y-8">
        <header className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Melden Sie sich an, um Ihr Dashboard und Ihre Kundenwebseite zu verwalten.
          </p>
        </header>
        ...
        <section className="card-surface p-6 sm:p-8">
          <form onSubmit={handleLogin} className="space-y-6" noValidate>
            <div className="space-y-2">
              ...
              <p id="email-description" className="text-xs text-gray-500">
                Wir verwenden diese Adresse für Anmeldebestätigungen und Passwort-Resets.
              </p>
            </div>
          ...
          <div className="mt-6 space-y-3 text-sm text-gray-600">
            <button
              ...
              className="flex w-full items-center justify-center gap-x-2 rounded-xl border border-transparent bg-brand/10 px-4 py-3 font-medium text-brand transition hover:bg-brand/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand disabled:cursor-not-allowed disabled:opacity-60"
            >
