        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <div className="mt-10 prose prose-lg prose-slate max-w-none">
            ...
            */}
            ...
            <p>
              Ihre Daten werden verarbeitet, um Ihnen diesen Dienst 
              (ArtisanCMS) zur Verfügung zu stellen. Nachfolgend 
            ...
            <p>
              ...
              Walnut, CA 91789, USA, gehostet. Vercel erhebt 
              automatisch Server-Log-Dateien (IP-Adresse, Browsertyp, 
              Betriebssystem, Referrer URL, Uhrzeit) zur Sicherstellung 
              des Betriebs.
            </p>
            <p>
              Wir nutzen zudem Vercel Analytics, um die Nutzung unserer 
              Website zu analysieren. Dies hilft uns, die Website zu 
              verbessern. Vercel Analytics erfasst anonymisierte Daten 
              wie besuchte Seiten, Herkunftsland und Gerätetyp.
            </p>
            <p>
            ...
            <p>
              ...
              speichert Ihre Einwilligung (oder Ablehnung) im LocalStorage 
              Ihres Browsers (`cookie_consent`).
            </p>
            <p>
            ...
            <p>
              Wir nutzen Supabase Inc., 970 Toa Payoh North #07-04, 
              Singapur 318992, als unser Backend. Wenn Sie sich 
              registrieren, verarbeitet Supabase Ihre E-Mail-Adresse 
              und ein sicher verschlüsseltes Passwort (Hashing).
            </p>
            <p>
            ...
            <ul>
              <li><strong>Profildaten:</strong> Ihr Firmenname, Adresse, Telefonnummer, 
                Profiltexte, Farbauswahl, etc.</li>
              <li><strong>Projektdaten:</strong> Projekttitel, Notizen, 
                Beschreibungen und die von Ihnen hochgeladenen Projektbilder 
                (gespeichert in Supabase Storage).</li>
              <li><strong>Kundenstimmen:</strong> Von Ihnen eingegebene Referenztexte.</li>
              <li><strong>Feedback:</strong> Von Ihnen über das Feedback-Widget 
                eingereichte Nachrichten.</li>
            </ul>
            <p>
              Wir haben mit Supabase einen Auftragsverarbeitungsvertrag (AVV/DPA) 
              abgeschlossen.
            </p>
            ...
            <p>
              ...
              San Francisco, CA 94104-5401, USA, für den Versand von 
              Transaktions-E-Mails.
            </p>
            <p>
              Dies umfasst die E-Mail zur Bestätigung Ihrer Registrierung 
              sowie E-Mails zum Zurücksetzen Ihres Passworts. Ihre 
              E-Mail-Adresse wird zu diesem Zweck an Resend übermittelt.
            </p>
            <p>
            ...
            <p>
              Wir nutzen die Dienste von OpenAI (OpenAI, L.L.C., 3180 18th Street, 
              San Francisco, CA 94110, USA), um die 
            ...
            <p>
              ...
              um die technische Stabilität unseres Dienstes zu verbessern.
            </p>
            <p>
              Sentry dient ausschließlich der Fehleranalyse (Error-Tracking). 
              Wenn ein Fehler in der App auftritt, werden technische Daten 
              (z.B. IP-Adresse, Gerätetyp, Fehlerprotokoll) an Sentry 
              übermittelt, um uns bei der Behebung des Problems zu helfen.
            </p>
            <p>
