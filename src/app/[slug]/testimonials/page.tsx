  ...
  useEffect(() => {
    ...
    const fetchTestimonialsData = async () => {
      ...
      try {
        ...
        if (fetchError) {
          setError(
            `Kundenstimmen konnten nicht geladen werden: ${fetchError.message}`,
          );
        } else {
                ...
                testimonials.map((testimonial) => (
                  <div key={testimonial.id} className="py-12">
                    <div className="flex items-center gap-x-4">
                      <Image
                        className="size-12 flex-none rounded-full bg-gray-50 object-cover ring-1 ring-gray-200"
                    ...
                    <blockquote className="mt-6 text-lg italic leading-8 text-gray-800 before:content-['“'] after:content-['”'] sm:text-xl sm:leading-9">
