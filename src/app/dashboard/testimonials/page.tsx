...
type Testimonial = {
  ...
  projects: ProjectTitle[] | null; 
};

// --- ICONS ---
// (RatingIcon wird nicht mehr benötigt)
...
// --- RATING COMPONENT (Nicht mehr verwendet) ---
...
function TestimonialCard({
  ...
  const { id, author_name, body, is_published, created_at, projects } = testimonial;
    ...
    <div className="bg-slate-800 rounded-lg border border-slate-700 shadow-md divide-y divide-slate-700">
      ...
      <div className="p-4 flex justify-end space-x-3 bg-slate-800/50 rounded-b-lg">
        ...
        >
          ...
          <span>{isToggling ? 'Wird geändert...' : is_published ? 'Verbergen' : 'Veröffentlichen'}</span>
        </button>
        <button
