...
const DashboardIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    {" "}
    <path
      d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6A2.25 2.25 0 0115.75 3.75h2.25A2.25 2.25 0 0120.25 6v2.25a2.25 2.25 0 01-2.25 2.25h-2.25A2.25 2.25 0 0113.5 8.25V6zM13.5 15.75A2.25 2.25 0 0115.75 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25h-2.25a2.25 2.25 0 01-2.25-2.25v-2.25z"
      strokeLinecap="round"
...
const CreditCardIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h6m3-3.75l-3 3m3 0l-3-3m-3.75 0h.008v.008H7.5v-.008zM4.5 12.75h15a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25h-15a2.25 2.25 0 00-2.25 2.25v3.75a2.25 2.25 0 002.25 2.25z"
    />
  </svg>
);
...
function Sidebar({
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-64 shrink-0 flex-col border-r border-slate-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/70">
      <div className="mb-8 flex items-center px-5 pt-6">
        <div className="rounded-lg bg-gradient-to-br from-orange-500 to-orange-600 p-2 shadow-md">
          <DashboardIcon className="size-6 text-white" />
        </div>
        <div className="ml-3">
        ...
        <div className="absolute bottom-0 left-0 w-64 px-5 pb-6">
          ...
          <div className="flex items-center rounded-xl bg-orange-50/80 p-3 shadow-inner shadow-orange-100">
            ...
            <button
              ...
              title="Abmelden"
              className="ml-2 shrink-0 rounded-md p-2 text-orange-500 transition-colors hover:bg-orange-100 hover:text-orange-600"
            >
...
function SidebarLink({
  ...
  const baseClasses =
    "flex items-center p-4 text-base font-normal rounded-lg transition duration-75 group w-full";
  ...
  if (isExternal) {
    return (
      <a
        ...
        className={`${baseClasses} ${inactiveClasses} justify-between ${isDisabled ? "pointer-events-none cursor-not-allowed opacity-50" : ""}`}
      >
        <span className="flex items-center">
          <Icon className="size-6" />
          <span className="ml-3 text-left">{text}</span>
        </span>
        <ArrowTopRightOnSquareIcon className="size-4 text-slate-400 transition-colors group-hover:text-orange-500" />
      </a>
    );
  }
  ...
  return (
    <Link
      ...
      className={`${baseClasses} ${active ? activeClasses : inactiveClasses} ${isDisabled ? "pointer-events-none cursor-not-allowed opacity-50" : ""}`}
    >
      <Icon className="size-6" />
      <span className="ml-3 text-left">{text}</span>
    </Link>
...
export default function DashboardLayout({
  ...
  if (loadingProfile) {
    return (
      <div className="flex h-screen items-center justify-center bg-gradient-to-br from-orange-100 via-white to-slate-100 text-slate-600">
        {" "}
        Lade Daten...{" "}
      </div>
    );
      ...
      <div className="flex-1 overflow-y-auto">
        {fullProfile && isBetaActive(fullProfile) && (
          <div className="sticky top-0 z-10 mx-6 mt-6 rounded-lg border border-orange-200 bg-orange-50 px-4 py-3 text-xs text-orange-800 shadow-sm">
            <span className="font-semibold">Beta-Version:</span> Sie nutzen
            ArtisanCMS derzeit im Rahmen einer kostenlosen Beta-Phase.
          </div>
        )}
