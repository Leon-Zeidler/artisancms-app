...
const BuildingOfficeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18m-1.5-18h-12a1.5 1.5 0 00-1.5 1.5v16.5a1.5 1.5 0 001.5 1.5h12a1.5 1.5 0 001.5-1.5V4.5a1.5 1.5 0 00-1.5-1.5zM9 9h6v2H9V9z"
    />
  </svg>
);
const PaintBrushIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.450a4.5 4.5 0 008.9-2.766 3 3 0 00-1.72-2.812zM9.53 16.122a3 3 0 00.315-5.942a3 3 0 012.836-2.836a3 3 0 005.942-.315c0-1.606 1.488-2.659 2.96-2.659a2.25 2.25 0 012.4 2.45a4.5 4.5 0 00-2.767 8.901 3 3 0 00-2.81 1.721 3 3 0 01-2.836 2.836a3 3 0 00-5.942.315c-1.606 0-2.659-1.488-2.659-2.96z"
    />
  </svg>
);
...
const ShieldCheckIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 12.75L11.25 15 15 9.75M21 12c0 1.24-.32 2.395-.88 3.428l-6.118 6.118-6.117-6.118C3.32 14.395 3 13.24 3 12c0-5.188 4.5-9.428 9-9.428s9 4.24 9 9.428z"
    />
  </svg>
);
    ...
    >
      <div className="w-full max-w-lg rounded-3xl border border-amber-200 bg-white p-8 shadow-2xl shadow-amber-200/40">
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-xl font-bold leading-6 text-slate-900">
              Rechtstexte überschreiben?
            </h3>
            <div className="mt-4">
              <p className="text-sm leading-6 text-slate-700">
                Sind Sie sicher? Diese Aktion **überschreibt** Ihre aktuellen
                Inhalte in den Feldern "Impressum" und "Datenschutz" mit den
...
const ColorInput = ({
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <label
      htmlFor={name}
      className="block text-sm font-medium text-slate-600 sm:pt-2"
    >
      {label}
    </label>
    <div className="flex items-center gap-3">
      <input
        ...
        value={value || "#ffffff"}
        onChange={onChange}
        className="size-10 cursor-pointer rounded border border-slate-200 bg-white shadow-sm"
      />
      <input
        type="text"
        value={value || ""}
...
const LogoUploader = ({
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <label className="block text-sm font-medium text-slate-600 sm:pt-2">
      Logo
    </label>
    <div className="flex items-center gap-4">
      <div className="flex h-16 w-32 shrink-0 items-center justify-center overflow-hidden rounded-md border border-slate-200 bg-white text-slate-400 shadow-sm">
        {logoUrl ? (
          <Image
            src={logoUrl}
            alt="Logo preview"
...
const SettingsToggle = ({
  ...
  <div
    className={`grid grid-cols-1 items-center gap-4 sm:grid-cols-2 ${disabled ? "opacity-60" : ""}`}
  >
    <span className="flex grow flex-col">
      <span
        className={`text-sm font-medium ${disabled ? "text-slate-400" : "text-slate-600"}`}
      >
        {label}
      </span>
      <span className="text-xs text-slate-500">{description}</span>
    </span>
    <label className="relative inline-flex cursor-pointer items-center justify-self-end">
      <input
        type="checkbox"
        name={name}
        checked={isChecked}
...
function DangerZone({
  ...
  const hasImpressum =
    profile.impressum_text && profile.impressum_text.trim().length > 10;
  const hasDatenschutz =
    profile.datenschutz_text && profile.datenschutz_text.trim().length > 10;
  ...
  const handlePublishToggle = async () => {
    ...
    if (newStatus && !canPublish) {
      toast.error(
        "Bitte füllen Sie Impressum und Datenschutz aus, um die Seite zu veröffentlichen.",
      );
      return;
    }
    ...
    const toastId = toast.loading(
      newStatus
        ...
        : "Veröffentlichung wird zurückgezogen...",
    );
    ...
    try {
      ...
      toast.success(
        newStatus ? "Website ist jetzt live!" : "Website ist jetzt offline.",
        { id: toastId },
      );
    } catch (err: any) {
    ...
    <>
      ...
      >
        <div className="space-y-4 rounded-2xl border border-orange-100 bg-white/90 p-4 shadow-inner shadow-orange-100/40">
          <div className="grid grid-cols-1 items-start justify-between gap-4 sm:grid-cols-2 sm:gap-4">
            <div>
              ...
              {!canPublish && (
                <p className="mt-2 flex items-center gap-2 text-xs text-amber-600">
                  ...
                  <span>
                    Zum Veröffentlichen müssen Impressum & Datenschutz
                    ausgefüllt sein.
                  </span>
                </p>
              )}
            </div>
            <label className="relative inline-flex cursor-pointer items-center sm:justify-self-end">
              <input
                type="checkbox"
                checked={isPublished}
              ...
              <div
                className={`peer h-6 w-11 rounded-full bg-slate-200 transition after:absolute after:left-[2px] after:top-0.5 after:size-5 after:rounded-full after:border after:border-slate-200 after:bg-white after:transition-all peer-checked:bg-emerald-500 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:ring-2 peer-focus:ring-orange-200 peer-focus:ring-offset-2 peer-focus:ring-offset-white ${
                  isPublishing || (!isPublished && !canPublish)
        ...
        <div className="space-y-4 rounded-2xl border border-red-100 bg-red-50/80 p-4 shadow-inner shadow-red-100/40">
          <div>
            ...
            <p className="mt-1 text-sm text-red-600/80">
              ...
              werden. Alle Ihre Daten, Projekte und Einstellungen werden
              dauerhaft gelöscht.
            </p>
          </div>
...
export default function EinstellungenPage() {
  ...
  const [formData, setFormData] = useState<
    Omit<Profile, "id" | "logo_url" | "logo_storage_path">
  >({
    business_name: "",
    hero_title: "",
    hero_subtitle: "",
    ...
    if (type === "checkbox") {
      ...
      if (name === "industry") {
        ...
        if (!currentServices || currentServices.trim() === "") {
          ...
          toast.success(
            `Leistungs-Vorschläge für '${INDUSTRY_TEMPLATES[newIndustry].label}' geladen!`,
          );
        } else {
  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      try {
        ...
        console.error(
          "Failed to apply industry defaults after saving settings",
          defaultsError,
        );
      }
    }
  ...
  const handleChangeEmail = async (e: FormEvent) => {
    ...
    if (profileError) {
      ...
      toast.error(
        `Auth-E-Mail aktualisiert, aber Profil-Update fehlgeschlagen: ${profileError.message}`,
        {
          id: toastId,
          duration: 8000,
        },
        ...
        <div className="space-y-12 lg:col-span-3">
          ...
          <form onSubmit={handleSaveProfile} className="space-y-12">
            ...
            <div className="sticky top-0 z-10 -mx-1 -mt-1 flex items-center justify-between border-b border-orange-100 bg-white/90 px-6 py-4 shadow-sm shadow-orange-100/40 backdrop-blur">
              ...
              >
                {saving ? <ArrowPathIcon /> : <CheckIcon className="size-5" />}
            ...
            <section id="firmendaten" className="scroll-mt-32">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Diese Informationen werden auf Ihrer Webseite (z.B. im
                Impressum) angezeigt.
              </p>
            ...
            <section id="branding" className="scroll-mt-32">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Passen Sie das Aussehen Ihrer Webseite an.
              </p>
              <div className="mt-6 space-y-6 rounded-2xl border border-orange-100 bg-white/90 p-6 shadow-sm shadow-orange-100">
                <ColorInput
                  label="Primärfarbe (Brand)"
                  name="primary_color"
                  value={formData.primary_color ?? "#F97316"}
                  onChange={handleFormChange}
                />
                <ColorInput
                  label="Sekundärfarbe (Hintergrund)"
                ...
                <SettingsInput
                  ...
                  onChange={handleFormChange}
                  placeholder="z.B. Ihr Malerbetrieb in Musterstadt"
                />
                <SettingsInput
                  ...
                  onChange={handleFormChange}
                  placeholder="Kurzbeschreibung für den Seitenanfang"
                  type="textarea"
                  rows={3}
                />
                <LogoUploader
            ...
            <section id="seo" className="scroll-mt-32">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Helfen Sie der AI, bessere Texte für Sie zu generieren.
              </p>
              <div className="mt-6 space-y-6 rounded-2xl border border-orange-100 bg-white/90 p-6 shadow-sm shadow-orange-100">
                ...
                <SettingsInput
                  ...
                  onChange={handleFormChange}
                  placeholder="z.B. Badsanierung, Heizung, Fliesenleger, Dresden..."
                  type="textarea"
                  rows={3}
                />
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      onChange={handleFormChange}
                      className="mt-0 block w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-100"
                      placeholder="Eine Zeile pro Leistung, z.B. Sanitär: Installation und Reparatur..."
                    />
                    <button
                      type="button"
                      onClick={() => handleGenerateProfileText("services")}
                      disabled={
                        aiLoading === "services" || !formData.business_name
                      }
                      className={`absolute right-2 top-2 inline-flex items-center gap-x-1.5 rounded-full px-2.5 py-1.5 text-xs font-semibold text-white shadow-lg transition-colors ${aiLoading === "services" || !formData.business_name ? "cursor-not-allowed bg-slate-300" : "bg-orange-500 hover:bg-orange-400"}`}
                    >
                      <SparklesIcon
                        className={`size-4 ${aiLoading === "services" ? "animate-spin" : ""}`}
                      />
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      onChange={handleFormChange}
                      className="mt-0 block w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-100"
                      placeholder="Ein kurzer Text über Ihre Firma, Ihre Werte und Ihre Geschichte..."
                    />
                    <button
                      type="button"
                      onClick={() => handleGenerateProfileText("about")}
                      disabled={
                        aiLoading === "about" || !formData.business_name
                      }
                      className={`absolute right-2 top-2 inline-flex items-center gap-x-1.5 rounded-full px-2.5 py-1.5 text-xs font-semibold text-white shadow-lg transition-colors ${aiLoading === "about" || !formData.business_name ? "cursor-not-allowed bg-slate-300" : "bg-orange-500 hover:bg-orange-400"}`}
                    >
                      <SparklesIcon
                        className={`size-4 ${aiLoading === "about" ? "animate-spin" : ""}`}
                      />
            ...
            <section id="rechtliches" className="scroll-mt-32">
              ...
              <p className="mt-1 text-sm text-slate-600">
                WICHTIG: Diese Texte sind für den Betrieb einer Webseite in
              ...
              <div className="mt-6 flex items-start gap-3 rounded-2xl border border-red-200 bg-red-50/80 p-4 text-sm text-red-700 shadow-sm shadow-red-100">
                ...
                <div>
                  ...
                  <p>
                    ArtisanCMS stellt lediglich die technischen Eingabefelder
                    bereit. Sie sind **allein** für die Richtigkeit und
                    Aktualität Ihrer Texte verantwortlich. Lassen Sie diese
                    **zwingend von einem Anwalt** prüfen und individuell
                    anpassen.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4">
                <button
                  ...
                  className="rounded-full bg-orange-500 px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-orange-400"
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      id="datenschutz_text"
                      rows={10}
                      value={formData.datenschutz_text ?? ""}
                      onChange={handleFormChange}
                      className="mt-0 block w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-100"
                    ...
                    <button
                      ...
                      className="absolute right-2 top-2 inline-flex items-center gap-x-1.5 rounded-full bg-orange-500 px-2.5 py-1.5 text-xs font-semibold text-white shadow-lg transition hover:bg-orange-400"
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    <input
                      ...
                      required
                      className="w-full rounded-md border border-slate-200 bg-white px-3 py-2 pl-10 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-100"
                      placeholder="neue-email@beispiel.de"
                    />
                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                      <AtSymbolIcon className="size-5 text-slate-400" />
                    </div>
                  </div>
                </div>
                <div className="text-right">
