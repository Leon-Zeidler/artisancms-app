    ...
    <main className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 flex items-center justify-between gap-3">
        <div className="min-w-0">
          ...
          <h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-900">Hilfe & Support</h1>
          <p className="mt-1 text-base text-slate-600">Eine detaillierte Anleitung zur Nutzung von ArtisanCMS.</p>
        </div>
        <Link
          href="/dashboard"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[16rem,1fr] gap-8">
        ...
        <article className="rounded-2xl border border-orange-100 bg-white/90 p-6 text-slate-600 shadow-lg shadow-orange-100/40 sm:p-8 lg:p-10">
          ...
          <section id="start" className="scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-slate-900">1. Erste Schritte: Ihre Live-Webseite</h2>
          ...
          <section id="legal" className="scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-orange-500">2. Wichtig: Rechtliche Anforderungen</h2>
            <p className="text-lg leading-7 text-slate-600">
            ...
            <div className="mt-6 flex gap-4 rounded-md border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700">
              ...
              <div>
                <p className="font-semibold text-slate-900">Seite nicht veröffentlichbar?</p>
                <p>
          ...
          <section id="features" className="scroll-mt-24 space-y-6">
            <h2 className="mb-4 text-2xl font-bold text-slate-900">3. Kernfunktionen im Detail</h2>

            <div>
              <h4 className="text-lg font-semibold text-slate-900">Projekte & die AI-Bildanalyse</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold text-slate-900">Team / Über Uns</h4>
              <p className="mt-2 text-slate-600">
            ...
            <div>
              <h4 className="text-lg font-semibold text-slate-900">Kundenstimmen anfragen</h4>
              <p className="mt-2 text-slate-600">
            ...
            <div>
              <h4 className="text-lg font-semibold text-slate-900">Kontaktanfragen & AI-Antworten</h4>
              <p className="mt-2 text-slate-600">
          ...
          <section id="feedback" className="scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-slate-900">4. Feedback & Support (Beta)</h2>
            <p className="text-slate-600">
              Diese App ist in der Beta-Phase. Wenn Sie einen Fehler finden, etwas unklar ist oder Sie eine Idee für eine neue Funktion haben, nutzen Sie bitte den <strong className="text-orange-600">orangenen Feedback-Button</strong>, der
          ...
          <section id="faq" className="scroll-mt-24">
            ...
            <ul className="list-disc list-inside space-y-4 text-slate-600">
              <li>
                <strong className="text-orange-600">Wie veröffentliche ich meine Webseite?</strong>
                <br />
              ...
              <li>
                <strong className="text-orange-600">Wie ändere ich mein Passwort oder meine Login-E-Mail?</strong>
                <br />
              ...
              <li>
                <strong className="text-orange-600">Wie lösche ich mein Konto?</strong>
                <br />
