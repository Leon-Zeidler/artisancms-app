        ...
        <div className="rounded-2xl border border-orange-100 bg-white/90 p-6 shadow-lg shadow-orange-100/40">
          ...
          <div className="mt-4 space-y-3">
            ...
            {!loading && certs.length === 0 && (
              <p className="text-sm text-slate-500">Sie haben noch keine Zertifikate hochgeladen.</p>
            )}
            {certs.map((cert) => (
              <div key={cert.id} className="flex items-center justify-between rounded-lg border border-slate-200 bg-white p-3">
